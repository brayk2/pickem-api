    ...
    async def get_matchup_data(self, year: int, week: int, bookmaker: str):
        ...
        games = (
            GameModel.select(
                ...
                home_team_alias.abbreviation.alias("home_team_abbr"),
                ...
                away_team_alias.abbreviation.alias("away_team_abbr"),
